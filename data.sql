...
INSERT INTO LectureRooms(seatingCapacity, roomNumber, roomFloor) VALUES 
(20, 2, 1),
(30, 2, 2),
(40, 2, 3),
(50, 3, 1),
...
-- course 1, offering 3			
call add_course_offering(1, 200::MONEY, '2021-03-15'::DATE, '2021-10-15'::DATE, 2, 150, ARRAY['2021-10-26', '2021-10-28', '2021-11-05', '2021-11-08'::DATE], ARRAY[11,9,15,14], ARRAY[5,9,2,6]);
...
call add_course_offering(10, 99::MONEY, '2021-02-02'::DATE, '2021-06-17'::DATE, 3, 100, ARRAY['2021-07-12', '2021-07-20'::DATE], ARRAY[15,9], ARRAY[3,6]);
...
-- course 1, offering 1, session 2
call add_session(1, 1, date '2021-07-16', 15, 10, 1);  -- Test: session < offering startDate. Expect startDate of CourseOffering to change as well

-- course 6, offering 2, session 2
call add_session(6, 2, date '2021-07-16', 14, 9, 6);

-- course 5, offering 1, session 2
call add_session(5, 1, date '2021-07-22', 15, 9, 5); 
